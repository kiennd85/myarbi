...
let item_o2_rjv = {
  ...
  information: '',
  list_sell: [
    { amountA1: 100, crosschain_fee: 44, type: 'DEX', chain: 'BNB', name_dex: 'Pancake', token_base: 'USDT', token_r: 'WBNB', alert_gain: 'no', gain_lv1: 50 },
    ...
    { amountA1: 100, crosschain_fee: 44, type: 'CEX', chain: 'Step', name_cex: 'Gateio', cex_trade_fee: 0.003, alert_gain: 'no', gain_lv1: 3 },
  ],
};
...
let item_o2_dao = {
  ...
  token_base: 'BUSD',
  information: '',
  list_sell: [{ amountA1: 300, crosschain_fee: 0, type: 'CEX', chain: 'BSC', name_cex: 'Gateio', cex_trade_fee: 0.003, alert_gain: 'no' }],
};
...
let item_o3_dao = {
  ...
  information: '',
  list_sell: [
    { amountA1: 300, crosschain_fee: 0, type: 'CEX', chain: 'BSC', name_cex: 'Gateio', cex_trade_fee: 0.003, alert_gain: 'no', gain_lv1: 10 },
    { amountA1: 200, crosschain_fee: 0, type: 'CEX', chain: 'BSC', name_cex: 'Gateio', cex_trade_fee: 0.003, alert_gain: 'yes', gain_lv1: 2 },
  ],
};
...
let item_t1_kcal = {
  ...
  cex_withdraw_fee: 0,
  list_sell: [
    { amountA1: 300, crosschain_fee: 0, type: 'SWAP', chain: 'Step', name_dex: 'Step', token_base: 'FITFI', token_r: '', name_cex: 'Bybit', cex_trade_fee: 0.001, alert_gain: 'no', gain_lv1: 3 },
    { amountA1: 200, crosschain_fee: 0, type: 'SWAP', chain: 'Step', name_dex: 'Step', token_base: 'FITFI', token_r: '', name_cex: 'Bybit', cex_trade_fee: 0.001, alert_gain: 'no', gain_lv1: 1.5 },
...
let item_t2_kcal = {
  ...
  list_sell: [
    ...
    { amountA1: 100, crosschain_fee: 0, type: 'SWAP', chain: 'Step', name_dex: 'Step', token_base: 'FITFI', token_r: '', name_cex: 'Bybit', cex_trade_fee: 0.001, alert_gain: 'yes', gain_lv1: 1.2, alert_tele: 'no', gain_tele: 1.2, count: 0, count_interval: 45 },
    { amountA1: 100, crosschain_fee: 0, type: 'SWAP', chain: 'Step', name_dex: 'Step', token_base: 'FITFI', token_r: '', name_cex: 'Houbi', cex_trade_fee: 0.002, alert_gain: 'yes', gain_lv1: 1.2, alert_tele: 'no', gain_tele: 1.2, count: 0, count_interval: 45 },
    //{ amountA1: 100, crosschain_fee: 0, type: 'SWAP', chain: 'Step', name_dex: 'Step', token_base: 'FITFI', token_r: '', name_cex: 'Gateio', cex_trade_fee: 0.003, alert_gain: 'yes', gain_lv1: 1.2, alert_tele: 'no', gain_tele: 1.2, count: 0, count_interval: 45 },
  ],
};
...
let item_t1_spex = {
  ...
  list_sell: [
    ...
    { amountA1: 200, crosschain_fee: 0, type: 'SWAP', chain: 'Step', name_dex: 'Step', token_base: 'FITFI', token_r: '', name_cex: 'Houbi', cex_trade_fee: 0.001, alert_gain: 'yes', gain_lv1: 5, alert_tele: 'yes', gain_tele: 6, count: 0, count_interval: 45 },
  ],
};
